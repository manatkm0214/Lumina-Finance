  ...
  return (
    <section className="space-y-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      <div className="space-y-1">
        ...
        <p className="text-sm text-slate-500">今の家計状態をひと目で確認できます</p>
      </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4">
          ...
          <div className="mt-4 space-y-3 text-sm">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold text-slate-900">{state.incomes.length}件</span>
            </div>

            <div className="flex items-center justify-between">
              <span className="text-slate-500">登録支出件数</span>
              <span className="font-semibold text-slate-900">{state.expenses.length}件</span>
            </div>
          </div>
        </div>
